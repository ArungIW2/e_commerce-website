...
<header class="border-b bg-white">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
        ...
        <nav class="flex items-center gap-5 text-sm font-semibold">
            ...
            @auth
                <a href="{{ route('wishlist.index') }}">Wishlist <span class="text-indigo-600">({{ auth()->user()->wishlistItems()->count() }})</span></a>
...
<footer class="mt-20 border-t bg-white">
    <div class="mx-auto max-w-7xl px-6 py-8 text-sm text-slate-500">
        Laravel Commerce · PrestaShop-inspired e-commerce foundation
    </div>
</footer>
</body>
</html>
