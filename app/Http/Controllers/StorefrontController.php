...
class StorefrontController extends Controller
{
    ...
    public function show(Product $product): View { abort_unless($product->is_active,404);$product->load('category','images','variants.attributeValues.attribute');return view('store.product',compact('product')); }
